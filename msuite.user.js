...
module.exports = main;
},{"./keys":6,"./waitForKeyElements":10,"jQuery":11}],2:[function(require,module,exports){
var $ = require("jQuery");
...
},{"./keys":6,"./thisId":8,"./waitForKeyElements":10,"jQuery":11}],4:[function(require,module,exports){
function valentines () {
...
main();
},{"./activityChecker":1,"./autoResource":2,"./defaultTab":3,"./easterEggs":4,"./folders":5,"./keys":6,"./timetable":9,"jQuery":11}],8:[function(require,module,exports){
function thisId () {
...
function waitForKeyElements (
        ...
        if (targetNodes && targetNodes.length > 0) {
            ...
            */
            targetNodes.each(function () {
                var jThis = $(this),
                    alreadyFound = jThis.data('alreadyFound') || false;
        ...
        var controlObj = waitForKeyElements.controlObj || {},
            controlKey = selectorTxt.replace(/[^\w]/g, "_"),
            timeControl = controlObj[controlKey];
...
module.exports = waitForKeyElements;
